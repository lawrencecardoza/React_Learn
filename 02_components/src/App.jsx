...
const App = () => {
  return (
    ...
    <Card user='vishal' age={22} img='https://images.unsplash.com/photo-1770723963970-ace02c7db50e?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'/>
     <Card user='rita' age={22} img='https://images.unsplash.com/photo-1770723963970-ace02c7db50e?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'/>
    </div>
